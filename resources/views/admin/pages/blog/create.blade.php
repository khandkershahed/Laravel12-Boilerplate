                ...
                <div class="row">
                        ...
                        <x-metronic.select-option id="blog_category_id" name="blog_category_id"
                            ...
                            @foreach ($blogCats as $blogCat)
                                <option value="{{ $blogCat->id }}"
                                    {{ old('blog_category_id') == $blogCat->id ? 'selected' : '' }}>
                                    {{ $blogCat->name }}
                                </option>
                            @endforeach
                        </x-metronic.select-option>
                    ...
                    <div class="col-lg-9 mb-3">
                        ...
                        <x-metronic.textarea id="short_description"
                            name="short_description">{{ old('short_description') }}</x-metronic.textarea>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="author_name" type="text" name="author_name"
                            :value="old('author_name')"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <x-metronic.textarea id="quote" name="quote">{{ old('quote') }}</x-metronic.textarea>
                    </div>
                    ...
                    <div class="col-lg-9 mb-3">
                        ...
                        <textarea id="long_description_one" class="ckeditor" name="long_description_one">{{ old('long_description_one') }}</textarea>
                    </div>
                    ...
                    <div class="col-lg-9 mb-3">
                        ...
                        <textarea id="long_description_two" class="ckeditor" name="long_description_two">{{ old('long_description_two') }}</textarea>
                    </div>
                    ...
                    <div class="col-lg-9 mb-3">
                        ...
                        <textarea id="video_description" class="ckeditor" name="video_description">{{ old('video_description') }}</textarea>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="meta_title" type="text" name="meta_title"
                            placeholder="Enter SEO title" :value="old('meta_title')"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-4 mb-3">
                        ...
                        <x-metronic.input id="" class="tags" type="text" name="meta_tags"
                            placeholder="e,g: html,css,laravel" :value="old('meta_tags')"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-5 mb-3">
                        ...
                        <x-metronic.textarea id="meta_description"
                            name="meta_description">{{ old('meta_description') }}</x-metronic.textarea>
                    ...
                    <div class="col-lg-10 mb-3">
                        ...
                        <x-metronic.input type="text" id="tags" name="tags"
                            placeholder="e.g. Laravel, PHP, Blog" :value="old('tags')"></x-metronic.input>
                    </div>

                    <!-- Remove this entire block if the field is not needed -->
                    <div class="col-lg-2 mb-3">
