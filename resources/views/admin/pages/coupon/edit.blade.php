                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="name" type="text" name="name" placeholder="Enter the name"
                            value="{{ old('name', $coupon->name) }}"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="badge" type="text" name="badge" placeholder="Enter the Badge"
                            value="{{ old('badge', $coupon->badge) }}"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="coupon_code" type="text" name="coupon_code"
                            ...
                            value="{{ old('coupon_code', $coupon->coupon_code) }}"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-2 mb-3">
                        ...
                        <x-metronic.input id="price" type="number" step="0.01" name="price"
                            placeholder="Enter price" value="{{ old('price', $coupon->price) }}"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-2 mb-3">
                        ...
                        <x-metronic.input id="offer_price" type="number" step="0.01" name="offer_price"
                            placeholder="Enter offer price"
                            value="{{ old('offer_price', $coupon->offer_price) }}"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="start_date" type="datetime-local" name="start_date"
                            value="{{ old('start_date', $coupon->start_date) }}"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="expiry_date" type="datetime-local" name="expiry_date"
                            value="{{ old('expiry_date', $coupon->expiry_date) }}"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-2 mb-3">
                        ...
                        <x-metronic.input id="notification_date" type="datetime-local" name="notification_date"
                            value="{{ old('notification_date', $coupon->notification_date) }}"></x-metronic.input>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <textarea id="locations" class="form-control" cols="1" rows="1" name="locations">{{ old('locations', $coupon->locations) }}</textarea>
                        @error('locations')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <textarea id="url" class="form-control" cols="1" rows="1" name="url">{{ old('url', $coupon->url) }}</textarea>
                        @error('url')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <textarea id="source_url" class="form-control" cols="1" rows="1" name="source_url">{{ old('source_url', $coupon->source_url) }}</textarea>
                        @error('source_url')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <textarea id="map_url" class="form-control" cols="1" rows="1" name="map_url">{{ old('map_url', $coupon->map_url) }}</textarea>
                        @error('map_url')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <textarea id="description" class="ckeditor" name="description">{{ old('description', $coupon->description) }}</textarea>
                        @error('description')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
