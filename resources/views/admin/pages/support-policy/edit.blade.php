<x-admin-app-layout :title="'Support and Policy Edit'">
    <div class="card card-flash">
        ...
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('admin.support-policy.index') }}" class="btn btn-light-info">
        ...
        <div class="card-body pt-0">
            ...
            <form method="POST" action="{{ route('admin.support-policy.update', $item->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
