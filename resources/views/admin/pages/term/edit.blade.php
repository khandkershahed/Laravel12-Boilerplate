<x-admin-app-layout :title="'Term and Condition Edit'">
    <div class="card card-flash">
        ...
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('admin.term.index') }}" class="btn btn-light-info">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.select-option id="status" name="status" data-hide-search="true"
                            ...
                            <option></option>
                            <option value="active" {{ old('status', $term->status) == 'active' ? 'selected' : '' }}>
                                Active</option>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="title" type="text" name="title" placeholder="Enter the title"
                            :value="old('title', $term->title)"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="version" type="text" name="version" placeholder="Enter the version"
                            :value="old('version', $term->version)"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="effective_date" type="date" name="effective_date"
                            :value="old('effective_date', $term->effective_date)"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-3">
                        ...
                        <x-metronic.input id="expiration_date" type="date" name="expiration_date"
                            :value="old('expiration_date', $term->expiration_date)"></x-metronic.input>
                    </div>

                    <div class="col-lg-12 mb-3">
                        <x-metronic.label for="content"
                            class="col-form-label fw-bold fs-6 ">{{ __('Content') }}</x-metronic.label>
                        <textarea id="content" class="ckeditor" name="content">{{ old('content', $term->content) }}</textarea>
                    </div>
